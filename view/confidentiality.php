...
<div class="container">
    ...
    <a href="https://lapinou.tech/index.php?page=mentions-legales"></a>
    ...
    La collecte et le traitement de ces données répond à la (aux) finalité(s) suivante(s) : contact
    ...
    Le site <a href="https://lapinou.tech">lapinou.tech</a> est hébergé par :
    Hostinger
    61 Lordou Vironos Street, 6023 Larnaca, Chypre
    <a href="https://www.hostinger.fr/contact">https://www.hostinger.fr/contact</a>
    ...
    <p>
        Les données à caractère personnelles sont collectées par Lapinou.tech, entreprise individuelle au capital de 0 €, SIREN : 979756962.
        Le responsable du traitement des données à caractère personnel peut être contacté de la manière suivante :
        Par courrier à l'adresse : 33 Boulevard Jean Behra 06100 Nice ;
        Par téléphone, au 0770275724 ;
        Par mail : <a href="mailto:p.coelho@lapinou.tech">p.coelho@lapinou.tech</a>.
    </p>
    ...
    Pierre Da Silva Coelho - 33 Boulevard Jean Behra 06100 Nice - Contact : <a href="mailto:p.coelho@lapinou.tech">p.coelho@lapinou.tech</a>.
    ...
    <p>
        Pour exercer vos droits, veuillez adresser votre courrier à Lapinou.tech - 33 Boulevard Jean Behra 06100 Nice ou par mail à <a href="mailto:p.coelho@lapinou.tech">p.coelho@lapinou.tech</a>
        ...
        Consultez le site <a href="https://cnil.fr" target="_blank">cnil.fr</a> pour plus d'informations sur vos droits.
    </p>

    <h2>ARTICLE 6 : CONDITIONS DE MODIFICATION DE LA POLITIQUE DE CONFIDENTIALITÉ</h2>

    <p>
        L'éditeur du site <a href="https://lapinou.tech">lapinou.tech</a> se réserve le droit de pouvoir modifier la présente Politique à tout moment afin d'assurer aux utilisateurs du site sa conformité avec le droit en vigueur.
        ...
        La présente politique, éditée le 17/01/2024, a été mise à jour le 17/01/2024.
    </p>
